...
impl PySkipExistingSpec {
    #[new]
    #[pyo3(signature = (existing_path, file_format, key_column, io_config=None, read_kwargs=None, num_workers=None, cpus_per_worker=None, keys_load_batch_size=None, max_concurrency_per_worker=None, filter_batch_size=None, strict_path_check=false))]
    #[allow(clippy::too_many_arguments)]
    pub fn new(
        py: Python,
